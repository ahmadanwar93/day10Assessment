...
<body class="app__card">
    <?php
        ...
        $sql = "INSERT INTO customers (customer_name,customer_status) VALUES ('$userName',1)";
        ...
        // echo $userName;
        $sql = "SELECT customers_id, customer_name FROM customers WHERE customer_name = '$userName'";
        ...
        $sql = "INSERT INTO tac (tac_phone,tac_value,customers_id) VALUES ('$phoneUser','$tacUser','$customerId')";
        if ($conn->query($sql) === TRUE) {
            // echo 'success';
        }else{
            echo 'failure';
                        ...
                        <div class="top_camera_placeholder">
                            <div class='dropdownMenu'>
                                <form action='activity.php' method='post'>
                                    <label for='checkinComp'>Select which place are you currently want to check in? </label>
                                <?php
                                    ...
                                    // print_r ($row_2);
                                    echo "<select name='checkinComp' id='checkinComp'>";
                                    $i = 0;
                                    while($i < count($row_2)){
                                        echo "<option value='{$row_2[$i]["company_id"]}'>{$row_2[$i]['company_name']}</option>";
                                        // echo "<option value='{$row_2[$i]["company_id"]}'>'abcd'</option>";
                                        $i++;
                                    }
                                    echo "</select>";                        
                                ?>
