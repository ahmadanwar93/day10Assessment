...
<body>
        ...
        <div class="app__wrapper">
            ...
            <form action='tacno.php' method='post'> 
                ...
                <div class="form_app_submit_container">
                    <button type="submit" class="form_app_submit btn_blue" onclick="location.href='tacno.php';">Verify <span class="next_arrow_icon"><img src="dist/images/svg/arrow_right_white.svg" alt=""></span></button>
                </div>
            </form>
        </div>
    ...
    <?php
        ...
        // we want to store the userNameInput value into session variable and we want to carry them to the next page
        $_SESSION['userInputName'] = $userInputName;
        // echo $userInputName;
