    ...
    <div class="app__container">
        <div class="app__wrapper">
            ...
            <form action='mobileno.php' method='post'>
                <input type="text" class="form_app_text" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" name="userNameInput">
                ...
                <div class="form_app_submit_container">
                    <button class="form_app_submit btn_blue" onclick="location.href='mobileno.php';" type="submit">Next <span class="next_arrow_icon"><img src="dist/images/svg/arrow_right_white.svg" alt=""></span></button>
                </div>
            </form>
        </div>
    </div>
